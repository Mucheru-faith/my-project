<!DOCTYPE html>
<?php require_once("C:/xampp/htdocs/PROJECT CODING/Administrator/db_connect.php"); ?>
<html>
<head>
<title> SignUp</title>
...
$row = mysqli_fetch_assoc($res);
    ...
    $password = password_hash($password,PASSWORD_BCRYPT,$options);
           ...
           $result = mysqli_query($conn,"INSERT into registration values('','$fname','$lname','$username','$email','$password','$date')");
...
?>
      ...
      <?php if(isset($done)) 
      { ?>
    <div class="successmsg"><span style="font-size:100px;">&#9989;</span> <br> You have registered successfully . <br> <a href="../Administrator/login.php" style="color:#fff;">Login here... </a> </div>
      <?php } else { ?>
       <div class="signup_form">
		<form action="" method="POST">
  <div class="form-group">
  	<h2 style="padding:10px;text-align:center">Register As a Member</h2>
...
<div class="form-group">
  ...
  <button type="submit" name="signup" class="btn btn-primary btn-group-lg form_btn">SignUp</button>
   <p>Have an account?<a href="../Administrator/login.php">Log in</a> </p>
